...
export const TOKEN_CATEGORIES: readonly TokenCategory[] = [
  ...
  },
  {
    ...
    sourceFile: "app/globals.css",
    status: "IMPLEMENTED",
    note: "Used sparingly by design (drawers/dialogs/dropdowns only, ADR-0017 §1's 85% flat / 10% elevated / 5% tactile balance) -- not yet consumed by any real component (no dialog/drawer/dropdown primitive exists yet).",
    items: [
