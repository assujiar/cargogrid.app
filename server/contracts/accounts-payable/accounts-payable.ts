...
/** One currency's own real exposure -- app.get_finance_ap_exposure_summary returns
...
/** Maps one raw app.get_finance_ap_exposure_summary() row (snake_case) to this contract's camelCase shape. */
