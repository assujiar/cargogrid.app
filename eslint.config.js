...
const serviceRoleImportGuard = {
  ignores: [
    ...
    "app/(tenant)/\\[tenantSlug\\]/admin/loyalty-rewards/actions.ts",
    "app/(tenant)/\\[tenantSlug\\]/admin/master-data/actions.ts",
    "app/(tenant)/\\[tenantSlug\\]/admin/organization/actions.ts",
    "app/(tenant)/\\[tenantSlug\\]/admin/roles/actions.ts",
    "app/(tenant)/\\[tenantSlug\\]/admin/users/actions.ts",
    "app/(tenant)/\\[tenantSlug\\]/customer-quotes/actions.ts",
    "app/(tenant)/\\[tenantSlug\\]/commercial/imports/customers/actions.ts",
    "app/(tenant)/\\[tenantSlug\\]/commercial/imports/customers/page.tsx",
    "app/(tenant)/\\[tenantSlug\\]/customer-tickets/actions.ts",
    ...
    "app/(tenant)/\\[tenantSlug\\]/hris/imports/leave-opening-balance/actions.ts",
    "app/(tenant)/\\[tenantSlug\\]/hris/imports/leave-opening-balance/page.tsx",
    "app/(tenant)/\\[tenantSlug\\]/hris/imports/payroll-loans/actions.ts",
    "app/(tenant)/\\[tenantSlug\\]/hris/imports/payroll-loans/page.tsx",
    "app/(tenant)/\\[tenantSlug\\]/hris/imports/position-crosswalk/actions.ts",
    "app/(tenant)/\\[tenantSlug\\]/hris/imports/position-crosswalk/page.tsx",
    "app/(tenant)/\\[tenantSlug\\]/hris/imports/timesheet/actions.ts",
    "app/(tenant)/\\[tenantSlug\\]/hris/imports/timesheet/page.tsx",
    "app/(tenant)/\\[tenantSlug\\]/operations/fleet/actions.ts",
    "app/(tenant)/\\[tenantSlug\\]/operations/imports/inventory-opening-balance/actions.ts",
    "app/(tenant)/\\[tenantSlug\\]/operations/imports/inventory-opening-balance/page.tsx",
    "app/(tenant)/\\[tenantSlug\\]/operations/imports/items/actions.ts",
    "app/(tenant)/\\[tenantSlug\\]/operations/imports/items/page.tsx",
    "app/(tenant)/\\[tenantSlug\\]/operations/shipment-orders/\\[shipmentOrderId\\]/actions.ts",
    "app/(tenant)/\\[tenantSlug\\]/operations/shipment-orders/\\[shipmentOrderId\\]/pod/route.ts",
    "app/(tenant)/\\[tenantSlug\\]/procurement/assessments/actions.ts",
    "app/(tenant)/\\[tenantSlug\\]/procurement/compliance/vendors/actions.ts",
    "app/(tenant)/\\[tenantSlug\\]/procurement/imports/vendor-rates/actions.ts",
    "app/(tenant)/\\[tenantSlug\\]/procurement/imports/vendor-rates/page.tsx",
    "app/(tenant)/\\[tenantSlug\\]/procurement/imports/vendors/actions.ts",
    "app/(tenant)/\\[tenantSlug\\]/procurement/imports/vendors/page.tsx",
    "app/(tenant)/\\[tenantSlug\\]/procurement/vendors/\\[masterRecordId\\]/financial/actions.ts",
    "app/(tenant)/\\[tenantSlug\\]/procurement/vendors/intake/actions.ts",
