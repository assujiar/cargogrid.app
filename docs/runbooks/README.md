...
|---|---|---|
| [`human-execution-pack.md`](./human-execution-pack.md) | Exact steps for the launch items software cannot close itself — branch protection, tax-rate confirmation, UAT, penetration test, restore rehearsal, scheduler wiring, status page, second provider. Companion to `docs/runtime/COMMERCIAL_LAUNCH_READINESS.md` | `ADR-0027` Part B (2026-08-30) |
