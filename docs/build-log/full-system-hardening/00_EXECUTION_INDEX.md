...
| 14 | `HDN-382` | `CG-S15-HDN-014` | 382 | Observability | Reliability Assurance | `HDN-370` | `READY` |
...
**Tally: 21 rows — 1 `COMPLETED` (kickoff), 7 `BLOCKED`, 1 `READY` (`HDN-382`),
...
> ### `HDN-382` (Observability, `CG-S15-HDN-014`) is next
>
> - **`HDN-381` is `VERIFIED`.** Tier C closed, no Critical or High finding at
>   either round.
> - **`CG-S15-HDN-014` (`HDN-382`, Prompt 382, Observability) may now begin.**
