...
| 11 | `HDN-379` | `CG-S15-HDN-011` | 379 | Performance and Scalability | Performance Assurance | `HDN-370` | `COMPLETED` — first round only, Tier C pending. `ISS-2026-145` (the O(n²) `rbac-enforcement.sql` scan) `RESOLVED`, matched-pair verified, 1244× speedup; 892 unindexed-FK advisories categorized and deferred (`ISS-2026-239`); `auth_rls_initplan` regression guard re-verified clean, 1 informational blind spot documented (`ISS-2026-240`); 1 genuine new finding registered (`ISS-2026-238`, Medium — 3 routes load unbounded tenant datasets). See `HDN-379.md` |
...
**Tally: 21 rows — 2 `COMPLETED` (kickoff, `HDN-379` first round only), 10 `BLOCKED`,
9 `VERIFIED` (`HDN-370`, `HDN-371`, `HDN-372`, `HDN-373`, `HDN-374`, `HDN-375`, `HDN-376`, `HDN-377`, `HDN-378`).**
...
> - **Carry-forward, still open, not `HDN-379`'s own to resolve unless squarely in its own
...
**Nothing after `HDN-379` may begin until `HDN-379` is `VERIFIED`.**
