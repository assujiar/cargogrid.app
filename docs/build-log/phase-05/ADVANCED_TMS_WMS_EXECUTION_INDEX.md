...
| `CG-S10-ATW-012` | 231 — WMS Inbound | Warehouse Execution / Inbound Order Control | `ATW-229..230` (both `VERIFIED`), verified customer/item/master and shipment contracts | `ATW-232`, `ATW-233`, `ATW-238` | `NOT_STARTED` | **Not yet dependency-clean** -- no item/SKU/product master type has ever been registered anywhere in this repository (confirmed against `app.master_types`'s own seeded rows: only `vendor_rate`/`vendor`/`fleet`/`vehicle`/`driver` exist); §9's own "verified... item/master... contracts" is unmet regardless of `ATW-229`/`230` both being `VERIFIED` |
...
### 1.3 Full-column detail — `READY` row (`229`), plus rows `224`, `225`, `226A`-`226I`, `227`, and `228` now `VERIFIED`
...
| State | Count |
|---|---|
| `VERIFIED` | 17 (`220`, `221`, `222`, `223`, `224`, `225`, `226A`, `226B`, `226C`, `226D`, `226E`, `226F`, `226G`, `226H`, `226I`, `227`, `228` -- row `226` itself, `CG-S10-ATW-007`, is fully `VERIFIED`) |
| `READY` | 1 (`229`) |
