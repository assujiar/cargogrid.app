...
| `CG-S13-CPL-003` | 301 | Customer Portal Dashboard | `CPL-002` `VERIFIED` | **`READY`** — dependency-clean, next eligible |
...
**`CG-S13-CPL-003` (Prompt 301, Customer Portal Dashboard).** Dependency-clean — `CPL-002` `VERIFIED` (§15).
