...
| `CG-S13-CPL-007` | 305 | Tracking | `CPL-002` | **`READY`** — dependency-clean, next eligible, first prompt of Batch 2 |
...
**`CG-S13-CPL-007` (Prompt 305, Tracking).** Dependency-clean — `CPL-002` `VERIFIED` (§15), Batch 1 (`CPL-002..006`, Prompts 300-304) closed `VERIFIED` (§16). First prompt of Batch 2 (`CPL-007..011`, Prompts 305-309).
