...
| `CG-S14-IAE-014` | 342 | Email, WhatsApp and SMS Integrations | `IAE-008` (as originally planned; to be confirmed or corrected, per Batch 3's own precedent, when this capability's own migration is actually built) | `READY` (merged Batch 4, §5 revision) |
| `CG-S14-IAE-015` | 343 | Maps, GPS and Telematics Integrations | `IAE-008` (as originally planned; to be confirmed or corrected when built) | `READY` (merged Batch 4, §5 revision) |
| `CG-S14-IAE-016` | 344 | Carrier, Port, Airport and Customs Integrations | `IAE-008` (as originally planned; to be confirmed or corrected when built) | `READY` (merged Batch 4, §5 revision) |
| `CG-S14-IAE-017` | 345 | Bank, Payment, eInvoice and Tax Integrations | `IAE-008` (as originally planned; to be confirmed or corrected when built) | `READY` (merged Batch 4, §5 revision) |
| `CG-S14-IAE-018` | 346 | External Accounting and HR Integrations | `IAE-008` (as originally planned; to be confirmed or corrected when built) | `READY` (merged Batch 4, §5 revision) |
| `CG-S14-IAE-019` | 347 | AI Governance Provider Boundary | `IAE-001` | `READY` (merged Batch 4, §5 revision) |
| `CG-S14-IAE-020` | 348 | AI-Assisted Quotation | `IAE-019` | `BLOCKED` — needs `IAE-019` `COMPLETED` first (merged Batch 4, §5 revision) |
...
Planned batch grouping for review cadence (`AGENTS.md` "Execution cadence", stated before any code is written, per §5): **Batch 1** `IAE-002..006` (Prompts 330-334); **Batch 2** `IAE-007..008` (335-336, 2 prompts); **Batch 3** `IAE-009..013` (337-341). **Batches 4-5 were merged into one "Batch 4" after Batch 3's close, by explicit operator instruction (§5 revision):** `IAE-014..020` (342-348, 7 prompts) — the original 5+2 split is superseded, not layered alongside it. Groups 6-9 (`IAE-021..039`, Prompts 349-367) are recorded for WBS completeness only and are not scheduled by this checkpoint.
