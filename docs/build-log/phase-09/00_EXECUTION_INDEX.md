...
**`CG-S14-IAE-007`** (Prompt 335, Automation Rule Engine, Batch 2) is now the first eligible prompt, released by Batch 1's own `VERIFIED` status per `AGENTS.md`'s cross-batch rule.
