...
| 277 | `CG-S12-HRT-005` | Onboarding and offboarding | **READY** | Upstream: `HRT-276`, now `VERIFIED` (see row above). No additional ownership/security/privacy conflict disclosed against this row's own stated scope. |
...
**Summary: 4 VERIFIED (273, 274, 275, 276), 1 READY (277), 20 BLOCKED (278–297).**
