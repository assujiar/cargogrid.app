...
| `005` | `84` ADR Baseline and Decision Governance | Governance and Source Control / Decision Governance / ADR baseline and register | `READY` | `PH0-081..083` (all `VERIFIED`) | `agent/cargogrid-autonomous-build` | Governance/decision-register/build-log documentation paths (§11 of `84_*.md`) | `docs/build-log/phase-00/PH0-84.md` + ADR register | Baseline: reconciled Step 3 + adopted Phase 0 baseline. Final: `84_*.md` acceptance criteria | Runtime build agent | `02_CONFIRMED_DECISION_REGISTER.md`, open `ADR-CAND-ARCH-*` list, `PH0-83.md` §4 | `CG-S5-PH0-006` |
