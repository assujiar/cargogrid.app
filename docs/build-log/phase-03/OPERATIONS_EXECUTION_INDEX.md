...
| `005` | `171` Land, air and sea baseline | Shipment Execution / Mode Baseline | `READY` | `OPS-169..170` (`VERIFIED`) | — | `docs/build-log/phase-03/OPS-171.md` | Runtime build agent | `CG-S8-OPS-006` |
