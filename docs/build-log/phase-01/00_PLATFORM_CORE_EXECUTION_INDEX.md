...
| `003` | `106` Subscription/module/feature entitlement | Identity and Tenancy / `TEN-IAM` | `READY` | `PLT-105` (`VERIFIED`) | `claude/lanjut-btusq6` | `docs/build-log/phase-01/PLT-106.md` | — | Execute `106_SUBSCRIPTION_MODULE_FEATURE_ENTITLEMENT_PROMPT.md` |
