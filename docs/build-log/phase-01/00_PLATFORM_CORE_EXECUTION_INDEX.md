...
| `002` | `105` Tenant provisioning and lifecycle | Identity and Tenancy / `TEN-IAM` | `READY` | `PLT-104` (`VERIFIED`) | `claude/lanjut-btusq6` | `docs/build-log/phase-01/PLT-105.md` | — | `CG-S6-PLT-003` |
| `003` | `106` Subscription/module/feature entitlement | Identity and Tenancy / `TEN-IAM` | `BLOCKED` | `PLT-105` | — | `docs/build-log/phase-01/PLT-106.md` | — | Missing: `105` not yet `VERIFIED` |
| `004` | `107` Supabase Auth integration | Identity and Tenancy / `TEN-IAM` | `BLOCKED` | `PLT-104..106` | — | `docs/build-log/phase-01/PLT-107.md` | — | Missing: `105`,`106` not yet `VERIFIED` |
