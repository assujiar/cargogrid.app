...
| `026` | `129` API key and webhook primitives | API and Jobs / `API-WH` | `READY` (dependencies satisfied) | `PLT-107`,`112..116`,`127` (all `VERIFIED`) | `claude/lanjut-i0o5bt` | `docs/build-log/phase-01/PLT-129.md` | — | Dependencies satisfied, but requires fresh explicit user authorization before executing `129_API_KEY_WEBHOOK_PRIMITIVES_PROMPT.md` (this checkpoint was authorized by a single, unscoped "lanjut," not a range — see `docs/runtime/HANDOFF.md`) |
