...
| `016` | `119` Localization | White-Label and Localization / `WLB` | `READY` | `PLT-117` (`VERIFIED`) | `claude/lanjut-i0o5bt` | `docs/build-log/phase-01/PLT-119.md` | — | Execute `119_LOCALIZATION_PROMPT.md` |
