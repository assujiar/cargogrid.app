...
| `015` | `118` Custom domain | White-Label and Localization / `WLB` | `READY` | `PLT-107`,`117` (both `VERIFIED`) | `claude/lanjut-i0o5bt` | `docs/build-log/phase-01/PLT-118.md` | — | Execute `118_CUSTOM_DOMAIN_PROMPT.md` |
