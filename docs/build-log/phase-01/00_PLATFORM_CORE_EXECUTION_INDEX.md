...
| `014` | `117` White-label foundation | White-Label and Localization / `WLB` | `READY` | `PLT-105..106`,`116` (all `VERIFIED`) | `claude/lanjut-btusq6` | `docs/build-log/phase-01/PLT-117.md` | — | Execute `117_WHITE_LABEL_FOUNDATION_PROMPT.md` |
