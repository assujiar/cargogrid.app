...
| `011` | `114` Field-level and record-level access | Identity and Tenancy / `TEN-IAM` | `READY` | `PLT-112..113` (both `VERIFIED`) | `claude/lanjut-btusq6` | `docs/build-log/phase-01/PLT-114.md` | — | Execute `114_FIELD_RECORD_ACCESS_PROMPT.md` |
