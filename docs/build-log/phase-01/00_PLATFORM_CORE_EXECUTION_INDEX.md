...
| `020` | `123` Approval engine | Governed Engines / `APPR` | `READY` | `PLT-111..116`,`122` (all `VERIFIED`) | `claude/lanjut-i0o5bt` | `docs/build-log/phase-01/PLT-123.md` | — | Execute `123_APPROVAL_ENGINE_PROMPT.md` |
