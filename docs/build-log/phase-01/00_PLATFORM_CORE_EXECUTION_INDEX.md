...
| `008` | `111` Role and permission builder | Identity and Tenancy / `TEN-IAM` | `READY` | `PLT-108..110` (all `VERIFIED`) | `claude/lanjut-btusq6` | `docs/build-log/phase-01/PLT-111.md` | — | Execute `111_ROLE_PERMISSION_BUILDER_PROMPT.md` |
