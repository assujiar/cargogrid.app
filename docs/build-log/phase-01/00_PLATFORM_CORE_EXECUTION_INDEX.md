...
| `017` | `120` Master data foundation | Data and Configuration Foundation / `MDM` | `READY` | `PLT-105`,`109`,`113..116` (all `VERIFIED`) | `claude/lanjut-i0o5bt` | `docs/build-log/phase-01/PLT-120.md` | — | Execute `120_MASTER_DATA_FOUNDATION_PROMPT.md` |
