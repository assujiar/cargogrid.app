...
| `006` | `109` Organization hierarchy | Identity and Tenancy / `TEN-IAM` | `READY` | `PLT-105`,`108` (both `VERIFIED`) | `claude/lanjut-btusq6` | `docs/build-log/phase-01/PLT-109.md` | — | Execute `109_ORGANIZATION_HIERARCHY_PROMPT.md` |
