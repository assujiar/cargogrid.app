...
**Version:** `0.1.2` (2026-08-07 — added `CON-015`, resolving the §36 downstream-release-gate tension created by `ADR-0021`'s batched review cadence; no existing row altered)  
