> **SUPERSEDED (2026-07-14, `KI-004`):** this file is a stale duplicate from an earlier bootstrap lineage. The canonical, actively maintained copy is `/CARGOGRID_CONTEXT.md` at the repository root (or, for `CHANGE_MANIFEST.md`, this remains the only copy until a root instance is created). Do not edit this file as canonical.
