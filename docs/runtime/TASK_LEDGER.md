...
| `CG-S5-PH0-012` | Testing Foundation | Phase 0 / Foundation | `READY` | — | `agent/cargogrid-autonomous-build` | `CG-S5-PH0-011` (VERIFIED) | — | 2026-07-15 | **NEXT** — execute `91_TESTING_FOUNDATION_PROMPT.md`; resolves `ADR-CAND-ARCH-022/023` incl. the visual-regression tool `PH0-090` deferred |
