...
| `CG-S6-PLT-008` | Role and Permission Builder | Phase 1 / Platform Core | `READY` | — | `claude/lanjut-btusq6` | `CG-S6-PLT-007` (VERIFIED) | — | 2026-07-16 | **NEXT** — execute `111_ROLE_PERMISSION_BUILDER_PROMPT.md` |
