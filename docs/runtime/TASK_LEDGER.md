...
| `CG-S5-PH0-018` | Product Analytics Baseline | Phase 0 / Foundation | `READY` | — | `claude/lanjut-btusq6` | `CG-S5-PH0-017` (VERIFIED) | — | 2026-07-15 | **NEXT** — execute `97_PRODUCT_ANALYTICS_BASELINE_PROMPT.md` |
