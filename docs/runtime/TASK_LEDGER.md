...
| `CG-S6-PLT-011` | Field-Level and Record-Level Access | Phase 1 / Platform Core | `READY` | — | `claude/lanjut-btusq6` | `CG-S6-PLT-010` (VERIFIED) | — | 2026-07-16 | **NEXT** — execute `114_FIELD_RECORD_ACCESS_PROMPT.md` |
