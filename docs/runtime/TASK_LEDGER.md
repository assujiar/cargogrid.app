...
| `CG-S5-PH0-005` | ADR Baseline and Decision Governance | Phase 0 / Foundation | `READY` | — | `agent/cargogrid-autonomous-build` | `CG-S5-PH0-004` (VERIFIED) | — | 2026-07-15 | **NEXT** — execute `84_ADR_BASELINE_DECISION_GOVERNANCE_PROMPT.md`; formalizes the standing ADR register incl. the `ADR-CAND-ARCH-011` resolution recorded in `PH0-83.md` |
