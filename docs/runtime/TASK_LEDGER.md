...
| `CG-S6-PLT-009` | RBAC Enforcement | Phase 1 / Platform Core | `READY` | — | `claude/lanjut-btusq6` | `CG-S6-PLT-008` (VERIFIED) | — | 2026-07-16 | **NEXT** — execute `112_RBAC_ENFORCEMENT_PROMPT.md` |
