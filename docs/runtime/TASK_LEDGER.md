...
| `CG-S5-PH0-015` | Security Baseline Controls | Phase 0 / Foundation | `READY` | — | `claude/lanjut-btusq6` | `CG-S5-PH0-014` (VERIFIED) | — | 2026-07-15 | **NEXT** — execute `94_SECURITY_BASELINE_CONTROLS_PROMPT.md` |
