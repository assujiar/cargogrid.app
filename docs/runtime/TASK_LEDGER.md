...
| `CG-S6-PLT-013` | Audit Trail Foundation | Phase 1 / Platform Core | `READY` | — | `claude/lanjut-btusq6` | `CG-S6-PLT-012` (VERIFIED) | — | 2026-07-16 | Blocked on user confirmation — `116_AUDIT_TRAIL_FOUNDATION_PROMPT.md` is outside the user's explicitly requested "sd prompt 115" range |
