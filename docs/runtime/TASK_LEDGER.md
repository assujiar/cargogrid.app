...
| `CG-S6-PLT-007` | User Lifecycle | Phase 1 / Platform Core | `READY` | — | `claude/lanjut-btusq6` | `CG-S6-PLT-006` (VERIFIED) | — | 2026-07-16 | **NEXT** — execute `110_USER_LIFECYCLE_PROMPT.md` |
