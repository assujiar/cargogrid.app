...
| `CG-S6-PLT-012` | Support Access and Impersonation | Phase 1 / Platform Core | `READY` | — | `claude/lanjut-btusq6` | `CG-S6-PLT-011` (VERIFIED) | — | 2026-07-16 | **NEXT** — execute `115_SUPPORT_ACCESS_IMPERSONATION_PROMPT.md` |
