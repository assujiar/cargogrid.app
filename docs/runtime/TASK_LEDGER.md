...
| `CG-S5-PH0-014` | Observability Baseline | Phase 0 / Foundation | `READY` | — | `claude/lanjut-btusq6` | `CG-S5-PH0-013` (VERIFIED) | — | 2026-07-15 | **NEXT** — execute `93_OBSERVABILITY_BASELINE_PROMPT.md`; resolves `ADR-CAND-ARCH-026` |
