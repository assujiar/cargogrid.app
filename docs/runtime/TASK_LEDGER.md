...
| `CG-S5-PH0-023` | Phase 0 Closure Verification | Phase 0 / Verification | `READY` | — | `claude/lanjut-btusq6` | `CG-S5-PH0-022` (VERIFIED) | — | 2026-07-16 | **NEXT** — execute `102_PHASE0_CLOSURE_VERIFICATION_PROMPT.md`; only this prompt may set `PHASE_0_VERIFIED` |
