...
| `CG-S6-PLT-004` | Supabase Auth Integration | Phase 1 / Platform Core | `READY` | — | `claude/lanjut-btusq6` | `CG-S6-PLT-003` (VERIFIED) | — | 2026-07-16 | **NEXT** — execute `107_SUPABASE_AUTH_INTEGRATION_PROMPT.md` |
