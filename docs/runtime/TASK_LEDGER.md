...
| `CG-S5-PH0-017` | Initial Threat Model | Phase 0 / Foundation | `READY` | — | `claude/lanjut-btusq6` | `CG-S5-PH0-016` (VERIFIED) | — | 2026-07-15 | **NEXT** — execute `96_INITIAL_THREAT_MODEL_PROMPT.md` |
