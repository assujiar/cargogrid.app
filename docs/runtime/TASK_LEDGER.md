...
| `CG-S6-PLT-003` | Subscription/Module/Feature Entitlement | Phase 1 / Platform Core | `READY` | — | `claude/lanjut-btusq6` | `CG-S6-PLT-002` (VERIFIED) | — | 2026-07-16 | **NEXT** — execute `106_SUBSCRIPTION_MODULE_FEATURE_ENTITLEMENT_PROMPT.md` |
