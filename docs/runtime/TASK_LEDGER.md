...
| `CG-S6-PLT-006` | Organization Hierarchy | Phase 1 / Platform Core | `READY` | — | `claude/lanjut-btusq6` | `CG-S6-PLT-005` (VERIFIED) | — | 2026-07-16 | **NEXT** — execute `109_ORGANIZATION_HIERARCHY_PROMPT.md` |
