      ...
      <div className="flex flex-wrap items-end gap-2">
        <form action={confirmFormAction} className="flex items-center gap-2">
          <label className="flex items-center gap-1 text-xs text-neutral-600">
            <input type="checkbox" name="overrideConflict" /> Override conflict
          </label>
        ...
        <form action={dismissFormAction} className="flex items-center gap-2">
          <input type="text" name="reviewNote" required placeholder="Reason for dismissal" className="rounded-md border border-neutral-300 px-2 py-1.5 text-sm" />
