...
import { validateRegistry, PHASE_0_REGISTRY, FINANCE_REGISTRY, PROCUREMENT_REGISTRY, type ClassificationEntry, type RegistryViolation } from "./registry.ts";

export const REGISTRY: readonly ClassificationEntry[] = [...PHASE_0_REGISTRY, ...FINANCE_REGISTRY, ...PROCUREMENT_REGISTRY];
