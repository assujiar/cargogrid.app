...
begin
  ...
  perform app.post_finance_ar_open_item(v_tenant_a, null, v_customer_id, 'invoice', pg_temp.iss319_mint_invoice(v_tenant_a, v_customer_id, '00000000-0000-0000-0000-000000028502', 'financemanagera', 'iss319-receiptalloc-1'), 'IDR', 1000000, '2026-03-01'::date, '2026-03-31'::date, '00000000-0000-0000-0000-000000028502', 'financemanagera');
  perform app.post_finance_ar_open_item(v_tenant_a, null, v_customer_id, 'invoice', pg_temp.iss319_mint_invoice(v_tenant_a, v_customer_id, '00000000-0000-0000-0000-000000028502', 'financemanagera', 'iss319-receiptalloc-2'), 'IDR', 500000, '2026-03-02'::date, '2026-04-01'::date, '00000000-0000-0000-0000-000000028502', 'financemanagera');
  perform app.post_finance_ar_open_item(v_tenant_a, null, v_customer_id, 'invoice', pg_temp.iss319_mint_invoice(v_tenant_a, v_customer_id, '00000000-0000-0000-0000-000000028502', 'financemanagera', 'iss319-receiptalloc-3'), 'IDR', 300000, '2026-03-03'::date, '2026-04-02'::date, '00000000-0000-0000-0000-000000028502', 'financemanagera');
end;
$$;

\echo '>> FIN-202 fixture prerequisite: a published finance_posting_map so app.allocate_finance_receipt''s own new subledger effect can resolve real accounts'
do $$
declare
  v_tenant_a uuid;
...
begin
  ...
  -- existing role's own permission set (other assertions in this file rely on
  -- its exact Edit/Approve/View shape).
  ...
  perform app.assign_role(v_tenant_a, (select id from app.role_versions where role_id = v_coa_role and status = 'published'), '00000000-0000-0000-0000-000000028502', '00000000-0000-0000-0000-000000028501', 'tester');

  select * into v_account from app.create_finance_account_draft(v_tenant_a, null, 'AR-CTRL', 'Accounts Receivable Control', 'asset', 'debit', null, false, null, '00000000-0000-0000-0000-000000028502', 'financemanagera');
