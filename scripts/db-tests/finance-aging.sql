...
-- own direct app.post_finance_ar_open_item calls below can no longer pass
...
begin
  ...
  select * into v_current_item from app.post_finance_ar_open_item(v_tenant_a, null, v_customer_id, 'invoice', pg_temp.iss319_mint_invoice(v_tenant_a, v_customer_id, '00000000-0000-0000-0000-000000035002', 'financemanagera', 'iss319-aging-current'), 'USD', 100, '2026-07-01'::date, '2026-07-20'::date, '00000000-0000-0000-0000-000000035002', 'financemanagera');
  -- 1-60 bucket: due 2026-06-20, as-of 2026-07-15 -> 25 days overdue
  select * into v_bucket2_item from app.post_finance_ar_open_item(v_tenant_a, null, v_customer_id, 'invoice', pg_temp.iss319_mint_invoice(v_tenant_a, v_customer_id, '00000000-0000-0000-0000-000000035002', 'financemanagera', 'iss319-aging-bucket2'), 'USD', 200, '2026-06-01'::date, '2026-06-20'::date, '00000000-0000-0000-0000-000000035002', 'financemanagera');
  -- 61+ bucket: due 2026-04-01, as-of 2026-07-15 -> 105 days overdue
  select * into v_bucket3_item from app.post_finance_ar_open_item(v_tenant_a, null, v_customer_id, 'invoice', pg_temp.iss319_mint_invoice(v_tenant_a, v_customer_id, '00000000-0000-0000-0000-000000035002', 'financemanagera', 'iss319-aging-bucket3'), 'USD', 50, '2026-03-01'::date, '2026-04-01'::date, '00000000-0000-0000-0000-000000035002', 'financemanagera');
  -- a held item, included by default, excludable
  select * into v_held_item from app.post_finance_ar_open_item(v_tenant_a, null, v_customer_id, 'invoice', pg_temp.iss319_mint_invoice(v_tenant_a, v_customer_id, '00000000-0000-0000-0000-000000035002', 'financemanagera', 'iss319-aging-held'), 'USD', 30, '2026-06-01'::date, '2026-06-25'::date, '00000000-0000-0000-0000-000000035002', 'financemanagera');
  ...
  select * into v_paid_item from app.post_finance_ar_open_item(v_tenant_a, null, v_customer_id, 'invoice', pg_temp.iss319_mint_invoice(v_tenant_a, v_customer_id, '00000000-0000-0000-0000-000000035002', 'financemanagera', 'iss319-aging-paid'), 'USD', 75, '2026-06-01'::date, '2026-06-25'::date, '00000000-0000-0000-0000-000000035002', 'financemanagera');
