...
begin
  ...
  perform app.post_finance_ar_open_item(v_tenant_a, null, v_customer_id, 'invoice', pg_temp.iss319_mint_invoice(v_tenant_a, v_customer_id, '00000000-0000-0000-0000-000000034002', 'financemanagera', 'iss319-reconciliation-1'), 'USD', 500, '2026-06-20'::date, '2026-07-20'::date, '00000000-0000-0000-0000-000000034002', 'financemanagera');
...
begin
  ...
  perform app.post_finance_ar_open_item(v_tenant_a, null, v_customer_id, 'invoice', pg_temp.iss319_mint_invoice(v_tenant_a, v_customer_id, '00000000-0000-0000-0000-000000034002', 'financemanagera', 'iss319-reconciliation-2'), 'USD', 150, '2026-07-20'::date, '2026-08-19'::date, '00000000-0000-0000-0000-000000034002', 'financemanagera');
